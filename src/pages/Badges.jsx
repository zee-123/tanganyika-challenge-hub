...
export default function Badges() {
  ...
  const allBadges = [
    ...BADGES.english.map(b => ({ ...b, subject: 'English', subjectIcon: 'ðŸ“–' })),
    ...BADGES.math.map(b => ({ ...b, subject: 'Maths', subjectIcon: 'âš”ï¸' })),
    ...BADGES.science.map(b => ({ ...b, subject: 'Science', subjectIcon: 'ðŸ”¬' })),
  ];
    ...
    <div className="min-h-screen pt-28 pb-10 relative"
      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          <div className="text-6xl mb-3 floating">ðŸŽ–ï¸</div>
          ...
          <div className="mt-3 inline-block px-4 py-2 rounded-xl text-purple-200 text-sm font-bold"
            ...
            ðŸŽ–ï¸ {earned.length} / {allBadges.length} Badges Earned
          </div>
        </motion.div>
