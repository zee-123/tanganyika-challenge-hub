    ...
    <div className="min-h-screen pt-28 pb-10 relative"
      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          ...
          <p className="text-purple-300">Grammar Â· Vocabulary Â· Language Skills</p>
          <div className="flex justify-center gap-2 mt-3 flex-wrap">
            {['ðŸ¥‰ Grammar Explorer', 'ðŸ¥ˆ Grammar Champion', 'ðŸ¥‡ English Master'].map(b => (
        ...
        <QuizEngine subject="english" pool={englishPool} gradient={gradient} icon="ðŸ“–" />
      </div>
    </div>
  );
}
